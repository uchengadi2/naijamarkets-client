...
export default function EntityPurchaseSchemes(props) {
  ...
  const [buyingPath, setBuyingPath] = useState(
    props.preference === undefined ? "all" : props.preference
  );
  ...
  const changeBuyingPathHandler = (event) => {
    ...
    props.updatePreferenceHandler(event.target.value);
      ...
      <Box>
        <FormControl variant="outlined" className={classes.accountType}>
          ...
          >
            ...
            <MenuItem value={"regular"}>Regular Shopping</MenuItem>
            <MenuItem value={"target"}>Shopping for Target Schemes</MenuItem>
            <MenuItem value={"credit"}>Shopping for Credit Schemes</MenuItem>
          </Select>
